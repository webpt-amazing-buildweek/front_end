...
export default function Home() {
  return (
    <div className={"home bg-black h-screen w-screen flex flex-col justify-center align-center"}>
      ...
      <h3 className={"text-white my-8 mx-auto text-2xl"}>Choose from thousands of items</h3>
      <Link className={"text-yellow-500 my-8 mx-auto text-2xl"} to={"user"}><h2>Get started today</h2></Link>
